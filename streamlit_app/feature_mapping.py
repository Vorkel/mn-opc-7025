...
def get_feature_description(feature_name: str) -> str:
    ...
    descriptions = {
        "EXT_SOURCES_MEAN": (
            "Moyenne des scores externes de crédit (plus élevé = meilleur risque)"
        ),
        "CREDIT_INCOME_RATIO": (
            "Ratio entre le montant du crédit et les revenus annuels"
        ),
        "AGE_YEARS": "Âge du client en années",
        "DAYS_EMPLOYED": (
            "Ancienneté professionnelle en jours (négatif = nombre de jours)"
        ),
        ...
        "REG_CITY_NOT_LIVE_CITY": (
            "La région de travail diffère de la ville de résidence"
        ),
        "REG_REGION_NOT_LIVE_REGION": (
            "La région de travail diffère de la région de résidence"
        ),
        "REG_REGION_NOT_WORK_REGION": (
            "La région de résidence diffère de la région de travail"
        ),
        "LIVE_REGION_NOT_WORK_REGION": (
            "La région de résidence diffère de la région de travail"
        ),
        "REG_CITY_NOT_WORK_CITY": (
            "La ville de résidence diffère de la ville de travail"
        ),
        ...
        "DAYS_LAST_PHONE_CHANGE": (
            "Nombre de jours depuis le dernier changement de téléphone"
        ),
        "CNT_FAM_MEMBERS": "Nombre de membres de la famille",
        "AMT_REQ_CREDIT_BUREAU_HOUR": (
            "Nombre de demandes de crédit au bureau de crédit (heure)"
        ),
        "AMT_REQ_CREDIT_BUREAU_DAY": (
            "Nombre de demandes de crédit au bureau de crédit (jour)"
        ),
        "AMT_REQ_CREDIT_BUREAU_WEEK": (
            "Nombre de demandes de crédit au bureau de crédit (semaine)"
        ),
        "AMT_REQ_CREDIT_BUREAU_MON": (
            "Nombre de demandes de crédit au bureau de crédit (mois)"
        ),
        "AMT_REQ_CREDIT_BUREAU_QRT": (
            "Nombre de demandes de crédit au bureau de crédit (trimestre)"
        ),
        "AMT_REQ_CREDIT_BUREAU_YEAR": (
            "Nombre de demandes de crédit au bureau de crédit (année)"
        ),
        ...
        "YEARS_BEGINEXPLUATATION_AVG": (
            "Moyenne des années depuis le début de l'exploitation"
        ),
        ...
        "YEARS_BEGINEXPLUATATION_MODE": (
            "Mode des années depuis le début de l'exploitation"
        ),
        ...
        "YEARS_BEGINEXPLUATATION_MEDI": (
            "Médiane des années depuis le début de l'exploitation"
        ),
